...
+ (ClockTableViewController * _Nonnull)shareInstance;
- (void)viewDidLoad;
...
- (void)CountingDownRefreshSencondWithTime:(NSString * _Nonnull)time;
- (NSInteger)currentMusicTime;
@end


@interface NSObject (SWIFT_EXTENSION(MusicLRC))
@end
